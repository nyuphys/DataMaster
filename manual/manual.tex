...
% This section will just have the general usage instructions
\addcontentsline{toc}{section}{Usage}
\section*{Usage}
\label{sec:usage}

% there should be a section here about the contents of the lab document i.e. talking about ``get'' and ``plot'' functions
